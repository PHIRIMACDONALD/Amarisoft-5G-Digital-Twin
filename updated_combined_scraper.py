...
def expose_prometheus_metrics(requests_sent, json_gnb_ueget, dl_bitrate_upf, ul_bitrate_upf):
    ...
    if num_ues_registered == 0:
        ...
        for ue_ix in range(num_ues_registered):
            ...
            dl_bitrate = json_gnb_ueget['ue_list'][ue_ix]['cells'][0]['dl_bitrate'] / 1e6  # Convert bps to Mbps
            ...
            ul_bitrate = json_gnb_ueget['ue_list'][ue_ix]['cells'][0]['ul_bitrate'] / 1e6  # Convert bps to Mbps
